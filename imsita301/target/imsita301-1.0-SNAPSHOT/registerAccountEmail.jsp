                        ...
                        <div class="row">
                            <div class="col-md-12" style="display:flex;">
                                ...
                                <div class="mb-3" style="width:30%">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="male" name="gender" value="True" class="form-check-input" checked>
                            ...
                            <div class="col-md-12" style="display:none;">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="phone" name="phone" class="form-control" placeholder="Vui lòng nhập email bạn">                                                                 
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
